...
export default class EventLoader {
  ...
  static eventLabelsMap = {
    ...
    NR: { name: "Nothing Reported", source: "HEK", color: "#d4d4d4" },
    OS: { name: "Oscillation", source: "HEK", color: "#81fffc" },
    PG: { name: "Plage", source: "HEK", color: "#ab8cff" },
    PT: { name: "Peacock Tail", source: "HEK", color: "#494a37" },
    PB: { name: "Prominence Bubble", source: "HEK", color: "#b3d5e4" },
    ...
    EE: { name: "Explosive Event", source: "HEK", color: "#fec00a" },
